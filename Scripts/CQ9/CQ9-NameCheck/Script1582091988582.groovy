...
FileInputStream file = new FileInputStream(new File(dirpath + '//Data//CQ9-Data.xlsx'))

XSSFWorkbook workbook = new XSSFWorkbook(file)

XSSFSheet sheet = workbook.getSheetAt(0)

Object excelFile = ExcelFactory.getExcelDataWithDefaultSheet(dirpath + '//Data//CQ9-Data.xlsx', 'sheet1', true)
...
FileOutputStream outFile = new FileOutputStream(new File(dirpath + '//Data//CQ9-Data.xlsx'))
